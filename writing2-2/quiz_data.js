    ...
    },
    {
        ...
        steps: [
            { 
                ...
                options: [
                    {t: "첫 번째 부등식 $(x-1)(x-4) \\le 0$ 의 해는 $1 \\le x \\le 4$ 이다.", c: true}, 
                    {t: "첫 번째 부등식 $(x-1)(x-4) \\le 0$ 의 해는 $x \\le 1$ 또는 $x \\ge 4$ 이다.", c: false}
                ] 
            },
            { 
                q: "2단계: 두 번째 부등식 $(x-4)(x+1) > 0$ 의 해를 구하면?", 
                options: [
                    {t: "두 번째 부등식 $(x-4)(x+1) > 0$ 의 해는 $x < -1$ 또는 $x > 4$ 이다.", c: true}, 
                    {t: "두 번째 부등식 $(x-4)(x+1) > 0$ 의 해는 $-1 < x < 4$ 이다.", c: false}
                ] 
            },
            { 
